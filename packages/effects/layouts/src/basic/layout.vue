...
<template>
  <VbenAdminLayout
    ...
    :footer-border-top-width="preferences.footer.borderTopWidth"
    :footer-border-right-width="preferences.footer.borderRightWidth"
    :footer-border-bottom-width="preferences.footer.borderBottomWidth"
    :footer-border-left-width="preferences.footer.borderLeftWidth"
  ...
  >
    ...
    <!-- 页脚 -->
    <template v-if="preferences.footer.enable && $slots.footer" #footer>
      <LayoutFooter>
