...
import type { BreadcrumbStyleType } from '@vben/runtime/types';

import type { IBreadcrumb } from '@vben-core/ui/shadcn';
...
import { VbenBreadcrumbView } from '@vben-core/ui/shadcn';
