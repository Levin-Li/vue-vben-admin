...
@Service({
  basePath: '/ScheduledTask',
  controllerClass: 'com.levin.oak.base.controller.BizScheduledTaskController',
  description: '调度任务管理',
  title: '调度任务',
  type: '系统数据-调度任务',
})
export class ScheduledTaskService extends RequestService {
  constructor() {
  ...
  @CRUD.ListTable({
    refEntityClass: 'com.levin.oak.base.entities.ScheduledTask',
  })
