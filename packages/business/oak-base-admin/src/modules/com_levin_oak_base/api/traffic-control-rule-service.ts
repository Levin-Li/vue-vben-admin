...
@Service({
  basePath: '/TrafficControlRule',
  controllerClass: 'com.levin.oak.base.controller.BizTrafficControlRuleController',
  description: '流量控制规则维护',
  title: '流量控制规则',
  type: '专家数据-流量控制规则',
})
export class TrafficControlRuleService extends RequestService {
  constructor() {
  ...
  @CRUD.ListTable({
    refEntityClass: 'com.levin.oak.base.entities.TrafficControlRule',
  })
...
export const trafficControlRuleService = new TrafficControlRuleService();
