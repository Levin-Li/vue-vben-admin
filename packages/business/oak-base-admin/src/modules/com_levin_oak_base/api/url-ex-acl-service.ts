...
@Service({
  basePath: '/UrlExAcl',
  controllerClass: 'com.levin.oak.base.controller.BizUrlExAclController',
  description: 'Url扩展拦截管理',
  title: 'Url扩展拦截',
  type: '专家数据-Url扩展拦截',
})
export class UrlExAclService extends RequestService {
  constructor() {
  ...
  @CRUD.ListTable({
    refEntityClass: 'com.levin.oak.base.entities.UrlExAcl',
  })
...
export const urlExAclService = new UrlExAclService();
