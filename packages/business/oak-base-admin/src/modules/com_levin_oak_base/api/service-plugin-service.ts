...
@Service({
  basePath: '/ServicePlugin',
  controllerClass: 'com.levin.oak.base.controller.BizServicePluginController',
  description: '服务插件管理',
  title: '服务插件',
  type: '专家数据-服务插件',
})
export class ServicePluginService extends RequestService {
  constructor() {
  ...
  @CRUD.ListTable({
    refEntityClass: 'com.levin.oak.base.entities.ServicePlugin',
  })
...
export const servicePluginService = new ServicePluginService();
