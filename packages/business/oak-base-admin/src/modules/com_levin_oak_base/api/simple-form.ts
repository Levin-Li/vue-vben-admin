...
export class SimpleFormService extends RequestService {
  constructor() {
  ...
  @CRUD.ListTable({
    refEntityClass: 'com.levin.oak.base.entities.SimpleForm',
  })
...
export const simpleFormService = new SimpleFormService();
