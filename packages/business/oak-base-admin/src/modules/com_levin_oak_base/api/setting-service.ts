...
@Service({
  basePath: '/Setting',
  controllerClass: 'com.levin.oak.base.controller.BizSettingController',
  description: '系统设置管理',
  title: '系统设置',
  type: '系统数据-系统设置',
})
export class SettingService extends RequestService {
  constructor() {
  ...
  @CRUD.ListTable({
    refEntityClass: 'com.levin.oak.base.entities.Setting',
  })
