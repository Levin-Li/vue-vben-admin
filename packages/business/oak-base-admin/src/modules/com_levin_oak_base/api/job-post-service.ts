...
@Service({
  basePath: '/JobPost',
  controllerClass: 'com.levin.oak.base.controller.BizJobPostController',
  description: '工作岗位管理',
  title: '工作岗位',
  type: '系统数据-工作岗位',
})
export class JobPostService extends RequestService {
  constructor() {
  ...
  @CRUD.ListTable({
    refEntityClass: 'com.levin.oak.base.entities.JobPost',
  })
