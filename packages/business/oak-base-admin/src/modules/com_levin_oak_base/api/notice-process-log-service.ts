...
@Service({
  basePath: '/NoticeProcessLog',
  controllerClass:
    'com.levin.oak.base.controller.BizNoticeProcessLogController',
  description: '通知处理日志管理',
  title: '通知处理日志',
  type: '业务数据-通知处理日志',
})
export class NoticeProcessLogService extends RequestService {
  constructor() {
  ...
  @CRUD.ListTable({
    refEntityClass: 'com.levin.oak.base.entities.NoticeProcessLog',
  })
...
export const noticeProcessLogService = new NoticeProcessLogService();
