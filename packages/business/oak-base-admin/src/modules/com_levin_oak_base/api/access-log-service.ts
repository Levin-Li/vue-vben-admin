...
@Service({
  basePath: '/AccessLog',
  controllerClass: 'com.levin.oak.base.controller.BizAccessLogController',
  description: '访问日志管理',
  title: '访问日志',
  type: '系统数据-访问日志',
})
export class AccessLogService extends RequestService {
  constructor() {
  ...
  @CRUD.ListTable({
    refEntityClass: 'com.levin.oak.base.entities.AccessLog',
  })
