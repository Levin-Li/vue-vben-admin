...
@Service({
  basePath: '/TenantApp',
  controllerClass: 'com.levin.oak.base.controller.BizTenantAppController',
  description: '租户应用管理',
  title: '租户应用',
  type: '系统数据-租户应用',
})
export class TenantAppService extends RequestService {
  constructor() {
  ...
  @CRUD.ListTable({
    refEntityClass: 'com.levin.oak.base.entities.TenantApp',
  })
...
export const tenantAppService = new TenantAppService();
