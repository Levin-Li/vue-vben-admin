...
@Service({
  basePath: '/ScheduledLog',
  controllerClass: 'com.levin.oak.base.controller.BizScheduledLogController',
  description: '调度日志管理',
  title: '调度日志',
  type: '系统数据-调度日志',
})
export class ScheduledLogService extends RequestService {
  constructor() {
  ...
  @CRUD.ListTable({
    refEntityClass: 'com.levin.oak.base.entities.ScheduledLog',
  })
...
export const scheduledLogService = new ScheduledLogService();
