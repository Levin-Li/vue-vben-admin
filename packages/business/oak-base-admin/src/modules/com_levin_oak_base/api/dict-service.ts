...
@Service({
  basePath: '/Dict',
  controllerClass: 'com.levin.oak.base.controller.BizDictController',
  description: '字典管理',
  title: '字典',
  type: '系统数据-字典',
})
export class DictService extends RequestService {
  constructor() {
  ...
  @CRUD.ListTable({
    refEntityClass: 'com.levin.oak.base.entities.Dict',
  })
  ...
  async retrieveByCode(params?: any, options?: any) {
    return this.get('retrieveByCode', {
      ...options,
      params,
    });
  }
