...
@Service({
  basePath: '/OpenArea',
  controllerClass: 'com.levin.oak.base.controller.BizOpenAreaController',
  description: '开通区域',
  title: '开通区域',
  type: '系统数据-开通区域',
})
export class OpenAreaService extends RequestService {
  constructor() {
  ...
  @CRUD.ListTable({
    refEntityClass: 'com.levin.oak.base.entities.OpenArea',
  })
...
export const openAreaService = new OpenAreaService();
