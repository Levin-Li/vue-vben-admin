...
@Service({
  basePath: '/Nation',
  controllerClass: 'com.levin.oak.base.controller.BizNationController',
  description: '国家管理',
  title: '国家',
  type: '系统数据-国家',
})
export class NationService extends RequestService {
  constructor() {
  ...
  @CRUD.ListTable({
    refEntityClass: 'com.levin.oak.base.entities.Nation',
  })
