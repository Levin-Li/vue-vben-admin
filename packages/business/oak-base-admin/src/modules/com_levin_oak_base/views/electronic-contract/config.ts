...
export const electronicContractPageCrudConfig: CrudPageConfig =
  withModuleCrudConfig({
    ...
    fields: [
      ...
      { key: 'name', label: '合同名称', required: true, search: true, table: true, width: 220 },
      { key: 'bizType', label: '业务类型', search: true, table: true, width: 140 },
      { key: 'bizOrderId', label: '业务订单ID', search: true, table: true, width: 160 },
      {
        key: 'category',
        label: '类别',
        required: true,
      ...
      { key: 'eSigningTechServiceProviderCode', label: '签署技术服务商', loadOptions: eSigningTechServiceProviderOptionsLoader, type: 'select', table: true, width: 160 },
