...
import { fundAccountLogService } from '../../api/fund-account-log-service';
import {
...
export const fundAccountLogPageCrudConfig: CrudPageConfig = {
  ...
  fields: [
    ...
    },
    {
      ...
      label: '交易类型',
      form: false,
      loadOptions: tradeTypeOptionsLoader,
      multiple: true,
      search: true,
      type: 'select',
    },
