...
export const partnerPageCrudConfig: CrudPageConfig = withModuleCrudConfig({
  ...
  fields: [
    ...
    { key: 'cityCode', label: '市级行政编码', layoutGroup: 'content', layoutOrder: 70, width: 140 },
    ...
    { key: 'shippingProvinceCode', label: '省级行政编码', complexGroupKey: 'shipping', layoutGroup: 'extension', layoutOrder: 240, maxLength: 6, width: 140 },
    { key: 'shippingCityCode', label: '市级行政编码', complexGroupKey: 'shipping', layoutGroup: 'extension', layoutOrder: 250, maxLength: 6, width: 140 },
    { key: 'shippingDistrictCode', label: '区县行政编码', complexGroupKey: 'shipping', layoutGroup: 'extension', layoutOrder: 260, maxLength: 6, width: 140 },
