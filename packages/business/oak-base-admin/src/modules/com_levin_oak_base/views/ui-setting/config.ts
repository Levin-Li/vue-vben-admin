...
export const uiSettingPageCrudConfig: CrudPageConfig = {
  ...
  fields: [
    ...
    { key: 'name', label: '名称', layoutGroup: 'basic', layoutOrder: 10, required: true, table: true, width: 180 },
    {
      key: 'code',
      label: '设置项编码',
      layoutGroup: 'basic',
    ...
    { key: 'type', label: '设置项类型', layoutGroup: 'basic', layoutOrder: 30, table: true, width: 140 },
    { key: 'domain', label: '域名', layoutGroup: 'scope', layoutOrder: 20, table: true, width: 180 },
    {
      key: 'orgCategory',
      label: '组织类别',
      layoutGroup: 'scope',
