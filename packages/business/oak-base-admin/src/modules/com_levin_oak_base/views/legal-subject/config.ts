...
export const legalSubjectPageCrudConfig: CrudPageConfig = withModuleCrudConfig({
  ...
  fields: [
    ...
    {
      key: 'cityCode', label: '城市编码', layoutGroup: 'basic', layoutOrder: 60,
    ...
    { key: 'shippingProvinceCode', label: '省级行政编码', areaCascader: { selectableLevels: ['province'], valueKey: 'shippingProvinceCode' }, complexGroupKey: 'shipping', layoutGroup: 'extension', layoutOrder: 340, type: 'area-cascader', width: 140 },
    { key: 'shippingCityCode', label: '市级行政编码', areaCascader: { selectableLevels: ['city'], valueKey: 'shippingCityCode' }, complexGroupKey: 'shipping', layoutGroup: 'extension', layoutOrder: 350, type: 'area-cascader', width: 140 },
    { key: 'shippingDistrictCode', label: '区县行政编码', areaCascader: { selectableLevels: ['district'], valueKey: 'shippingDistrictCode' }, complexGroupKey: 'shipping', layoutGroup: 'extension', layoutOrder: 360, type: 'area-cascader', width: 140 },
