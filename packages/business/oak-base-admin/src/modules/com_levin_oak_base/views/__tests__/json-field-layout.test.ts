...
const compactJsonFields = [
  ...
  'electronic-contract/config.ts:signingLog',
  'electronic-contract-template/config.ts:signerRoleDefinition',
  'electronic-contract-template/config.ts:defaultSealPositionRules',
  'electronic-contract-template/config.ts:templateFieldSchema',
  'electronic-invoice/config.ts:buyerInfo',
  'electronic-invoice/config.ts:sellerSnapshot',
  'electronic-invoice/config.ts:itemList',
  'electronic-invoice-provider-connection/config.ts:providerExInfo',
  'file-res/config.ts:exInfo',
  'fund-account-log/config.ts:tradeLog',
  'fund-account-log/config.ts:extInfo',
  'global-org-selector-setting/config.ts:valueContent',
  'import-export-template/config.ts:config',
  'open-area/config.ts:areaCodeList',
  'open-area/config.ts:exInfo',
  ...
  'ui-setting/config.ts:valueContent',
