...
import type { TabDefinition } from '@vben-core/foundation/typings';

import type { TabConfig, TabsProps } from '../../types';

import { computed, ref } from 'vue';

import { Pin, X } from '@vben-core/foundation/icons';
import { VbenContextMenu, VbenIcon } from '@vben-core/ui/shadcn';
          ...
          <div class="relative size-full px-1">
            ...
            >
              ...
              <X
                ...
                class="mt-[2px] size-3 cursor-pointer rounded-full stroke-accent-foreground/80 text-accent-foreground/80 opacity-0 transition-all hover:bg-accent hover:stroke-accent-foreground group-hover:opacity-100 group-[.is-active]:text-accent-foreground group-[.is-active]:opacity-100"
                @click.stop="() => emit('close', tab.key)"
              />
              <Pin
                v-show="tab.affixTab && tabsView.length > 1 && tab.closable"
                class="mt-[1px] size-3.5 cursor-pointer rounded-full text-accent-foreground/80 opacity-0 transition-all hover:text-accent-foreground group-hover:opacity-100 group-[.is-active]:text-accent-foreground group-[.is-active]:opacity-100"
