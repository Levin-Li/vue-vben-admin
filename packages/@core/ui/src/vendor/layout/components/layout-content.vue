...
import type { ContentCompactType } from '@vben-core/foundation/typings';

import { computed } from 'vue';

import { useLayoutContentStyle } from '@vben-core/foundation/composables';
import { Slot } from '@vben-core/ui/shadcn';
