...
const breadcrumbListPath =
  'packages/@core/ui/src/vendor/shadcn/ui/breadcrumb/BreadcrumbList.vue';
const breadcrumbPath =
  'packages/@core/ui/src/vendor/shadcn/components/breadcrumb/breadcrumb.vue';
const breadcrumbBackgroundPath =
  'packages/@core/ui/src/vendor/shadcn/components/breadcrumb/breadcrumb-background.vue';
