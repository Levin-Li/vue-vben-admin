...
import type { Recordable } from '@vben-core/foundation/typings';

import type { AlertProps, BeforeCloseScope, PromptProps } from './alert';

import { h, nextTick, ref, render } from 'vue';

import { useSimpleLocale } from '@vben-core/foundation/composables';
import { Input, VbenRenderContent } from '@vben-core/ui/shadcn';
import { isFunction, isString } from '@vben-core/foundation/shared/utils';
