import type { VxeTableGridOptions } from '@vben/runtime/plugins/vxe-table';
...
import { $te } from '@vben/runtime/locales';
import {
  setupVbenVxeTable,
  useVbenVxeGrid as useGrid,
} from '@vben/runtime/plugins/vxe-table';
import { get, isFunction, isString } from '@vben/runtime/utils';
...
export type * from '@vben/runtime/plugins/vxe-table';
