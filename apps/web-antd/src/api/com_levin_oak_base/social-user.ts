...
export class SocialUserService extends RequestService {
  constructor() {
  ...
  @CRUD.ListTable({
    refEntityClass: 'com.levin.oak.base.entities.SocialUser',
  })
...
export const socialUserService = new SocialUserService();
