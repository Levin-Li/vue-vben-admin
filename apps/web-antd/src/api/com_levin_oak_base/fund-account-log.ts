...
@Service({
  basePath: '/FundAccountLog',
  description: '资金账户交易记录管理',
  title: '资金账户交易记录',
  type: '业务数据-资金账户交易记录',
})
export class FundAccountLogService extends RequestService {
  constructor() {
  ...
  @CRUD.ListTable({
    refEntityClass: 'com.levin.oak.base.entities.FundAccountLog',
  })
...
export const fundAccountLogService = new FundAccountLogService();
