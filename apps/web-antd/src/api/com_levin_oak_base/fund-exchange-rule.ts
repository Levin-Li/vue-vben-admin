...
@Service({
  basePath: '/FundExchangeRule',
  description: '资金兑换规则管理',
  title: '资金兑换规则',
  type: '业务数据-资金兑换规则',
})
export class FundExchangeRuleService extends RequestService {
  constructor() {
  ...
  @CRUD.ListTable({
    refEntityClass: 'com.levin.oak.base.entities.FundExchangeRule',
  })
...
export const fundExchangeRuleService = new FundExchangeRuleService();
