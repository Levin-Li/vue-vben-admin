...
var index = require('../_chunks/dep-22864d8c.js');
var configProvider_hooks_useConfig = require('../config-provider/hooks/useConfig.js');
var observe = require('../_chunks/dep-e570f7b1.js');
var log = require('../_chunks/dep-b8c747ba.js');
require('../_chunks/dep-47a6d229.js');
var index$1 = require('../_chunks/dep-1f260aa4.js');
var index$2 = require('../_chunks/dep-d99f0536.js');
...
var helper = require('../_chunks/dep-0a5ee5d1.js');
...
var throttle = require('../_chunks/dep-251b319e.js');
var pick = require('../_chunks/dep-85216f54.js');
var isFunction = require('../_chunks/dep-7ebecea9.js');
var get = require('../_chunks/dep-fc13d8ec.js');
...
require('../_chunks/dep-7027c579.js');
  ...
  setup: function setup(props2, context) {
    ...
    return function () {
      ...
      var renderAffixedHeader = function renderAffixedHeader() {
        ...
        var affixHeaderEvents = index$2.useEventForward(table_utils_index.getAffixProps(props2.headerAffixedTop), {
        ...
        return !!(virtualConfig.isVirtualScroll.value || props2.headerAffixedTop) && (props2.headerAffixedTop ? Vue.createVNode(affix_index.Affix, Vue.mergeProps({
          ...
          "offsetTop": 0
        }, affixHeaderEvents.value), _isSlot(affixHeaderWithWrap) ? affixHeaderWithWrap : {
      ...
      var affixFooterEvents = index$2.useEventForward(table_utils_index.getAffixProps(props2.footerAffixedBottom), {
        onFixedChange: onFixedChange
      });
      ...
      var tableContent = Vue.createVNode("div", {
        ...
        "style": _objectSpread(_objectSpread({}, tableContentStyles.value), {}, {
          overflowAnchor: "none"
        }),
