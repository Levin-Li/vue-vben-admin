...
import { defineComponent, computed, toRefs, ref, inject, watch, onMounted, createVNode, mergeProps, nextTick } from 'vue';
import _defineProperty from '@babel/runtime/helpers/defineProperty';
import _typeof from '@babel/runtime/helpers/typeof';
import _slicedToArray from '@babel/runtime/helpers/slicedToArray';
import { isNull, isObject, merge, omit } from 'lodash-es';
import { FormItemInjectionKey } from '../form/constants/index.js';
import { s as setStyle } from '../_chunks/dep-aa9108d2.js';
import { c as calculateNodeSize, a as getValidAttrs, b as getCharacterLength } from '../_chunks/dep-332d72a8.js';
import '@babel/runtime/helpers/toConsumableArray';
import '../_chunks/dep-53e6346b.js';
import { u as useTNodeJSX } from '../_chunks/dep-8da78633.js';
import { u as useCommonClassName } from '../_chunks/dep-8004d9ee.js';
import { u as usePrefixClass } from '../_chunks/dep-8e303224.js';
import { u as useDisabled } from '../_chunks/dep-69601fdd.js';
import '../_chunks/dep-d05b388b.js';
import { u as useReadonly } from '../_chunks/dep-588dad55.js';
...
var _Textarea = defineComponent({
  ...
  setup: function setup(props2, _ref) {
    ...
    var adjustTextareaHeight = function adjustTextareaHeight() {
      ...
      } else if (attrs.style && (_attrs$style = attrs.style) !== null && _attrs$style !== void 0 && _attrs$style.height) {
        var _attrs$style2;
        textareaStyle.value = {
          height: (_attrs$style2 = attrs.style) === null || _attrs$style2 === void 0 ? void 0 : _attrs$style2.height
        };
      }
    };
    ...
    return function () {
      ...
      var classes = computed(function () {
        return ["".concat(name.value, "__inner"), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({}, "".concat(prefix.value, "-is-").concat(tStatus.value), tStatus.value), STATUS.value.disabled, disabled.value), STATUS.value.focused, focused.value), "".concat(prefix.value, "-resize-none"), _typeof(props2.autosize) === "object"), "".concat(prefix.value, "-hide-scrollbar"), props2.autosize === true)];
      });
