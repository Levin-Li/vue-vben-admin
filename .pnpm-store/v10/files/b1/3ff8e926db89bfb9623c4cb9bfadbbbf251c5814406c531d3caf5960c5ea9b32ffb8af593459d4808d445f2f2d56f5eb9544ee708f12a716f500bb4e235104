...
var _commonjsHelpers = require('./dep-d9203944.js');
var advancedFormat = require('./dep-319c1813.js');
var customParseFormat = require('./dep-edb58559.js');
var format = require('./dep-222c99e5.js');
var isFunction = require('./dep-7ebecea9.js');
var _baseSlice = require('./dep-ba16dbb9.js');
var _isIterateeCall = require('./dep-8a38ec70.js');
...
function chunk(array, size, guard) {
  if (guard ? _isIterateeCall.isIterateeCall(array, size, guard) : size === undefined) {
    ...
    size = nativeMax(advancedFormat.toInteger(size), 0);
  }
...
//# sourceMappingURL=dep-cc8c2384.js.map
